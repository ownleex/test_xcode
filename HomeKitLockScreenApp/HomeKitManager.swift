...
class HomeKitManager: NSObject, ObservableObject, HMHomeManagerDelegate {
    ...
    @Published var selectedSensor: SensorInfo? {
        didSet {
            ...
            if let sensor = selectedSensor {
                UserDefaults(suiteName: "group.com.votreSociete.HomeKitLockScreen")?
    ...
    override init() {
        ...
        if let sensorIDString = UserDefaults(suiteName: "group.com.votreSociete.HomeKitLockScreen")?.string(forKey: "selectedSensorID"),
    ...
    func homeManagerDidUpdateHomes(_ manager: HMHomeManager) {
        ...
        DispatchQueue.main.async {
            ...
            if self.selectedSensor == nil,
               let sensorIDString = UserDefaults(suiteName: "group.com.votreSociete.HomeKitLockScreen")?.string(forKey: "selectedSensorID"),
               let sensorUUID = UUID(uuidString: sensorIDString),
